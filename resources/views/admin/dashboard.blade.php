...
<body class="bg-canvas-soft text-ink flex h-screen overflow-hidden font-sans">
    ...
    <aside class="w-64 bg-brand-dark flex flex-col justify-between hidden lg:flex relative z-20 shrink-0">
        <div>
            ...
            <nav class="p-5 space-y-2 mt-4">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3 bg-white/10 text-white rounded-xl text-[14px] font-medium transition-all">
        ...
        <div class="p-5 border-t border-white/5">
            <div class="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/10">
                ...
                <div class="overflow-hidden">
                    <p class="text-[14px] text-white font-medium truncate">{{ Auth::user()->name ?? 'Pengguna' }}</p>

                    <!-- LOGIKA ROLE: Menampilkan status berdasarkan yang login -->
                    <p class="text-[11px] text-primary-subdued truncate">
                        {{ Auth::user()->role === 'admin' ? 'Platform Admin' : 'Event Organizer' }}
                    </p>
                </div>
            </div>
    ...
    <main class="flex-1 flex flex-col h-full overflow-y-auto relative z-10 w-full bg-[#f4f7fb]">
        ...
        <div class="px-8 pb-12">
            ...
            <!-- LOGIKA PERINGATAN (ALERT): Pesan sapaan berbeda untuk Admin & EO -->
            @if(Auth::user()->role === 'admin')
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4 mb-8">
                ...
                <!-- Bagian Sponsor: Opsional, bisa kamu sembunyikan dari EO jika EO tidak mengurus sponsor -->
                <div class="bg-white rounded-[20px] p-5 shadow-sm border border-gray-100 flex flex-col justify-between h-28 relative">
                    <div class="flex justify-between items-start">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // KODE DIPERBAIKI: Tanpa tanda kurung siku ganda yang membingungkan Blade
            ...
            // KODE DIPERBAIKI: Menggunakan json bersih
