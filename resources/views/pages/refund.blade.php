...
<head>
    ...
    <meta name="description" content="Kebijakan pengembalian dana (refund) dan pembatalan tiket di ekosistem platform event Ticks ID.">
...
<body class="bg-[#F8FAFC] text-slate-900 flex flex-col min-h-screen">
    ...
    <!-- Navbar Sederhana -->
    <nav class="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200 py-4" aria-label="Navigasi Kebijakan Refund">
        <div class="max-w-4xl mx-auto px-6 flex items-center justify-between">
            <a href="{{ url('/') }}" aria-label="Kembali ke Beranda" class="flex items-center gap-2 font-bold text-slate-600 hover:text-[#FF7A00] transition-colors">
