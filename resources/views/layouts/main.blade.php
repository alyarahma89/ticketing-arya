            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-3">
                        ...
                        <li><a href="https://wa.me/6282160762279?text=Halo%20Admin%20Ticks%20ID,%20saya%20ingin%20konsultasi%20kemitraan%20dan%20kerjasama%20event" target="_blank" rel="noopener noreferrer" class="text-sm font-medium transition-colors text-slate-500 hover:text-[#0066FF] dark:text-white/40 dark:hover:text-white/80">Konsultasi EO & Sponsorship</a></li>
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-3">
                        <li><a href="https://wa.me/6282160762279?text=Halo%20Admin%20Ticks%20ID,%20saya%20butuh%20bantuan%20seputar%20tiket" target="_blank" rel="noopener noreferrer" class="text-sm font-medium transition-colors text-slate-500 hover:text-[#0066FF] dark:text-white/40 dark:hover:text-white/80 flex items-center gap-1.5"><i data-lucide="help-circle" class="w-3.5 h-3.5 text-blue-500"></i> Help Center</a></li>
                        <li><a href="https://wa.me/6282160762279?text=Halo%20Admin%20Ticks%20ID" target="_blank" rel="noopener noreferrer" class="text-sm font-medium transition-colors text-slate-500 hover:text-[#0066FF] dark:text-white/40 dark:hover:text-white/80 flex items-center gap-1.5"><i data-lucide="message-circle" class="w-3.5 h-3.5 text-emerald-500"></i> Kontak</a></li>
