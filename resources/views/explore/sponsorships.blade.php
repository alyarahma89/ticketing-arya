...
<head>
    ...
    <title>Eksplorasi Sponsorship - ARTIX ID</title>
...
<body class="bg-slate-50 text-slate-900 dark:bg-[#020C1F] dark:text-white flex flex-col min-h-screen transition-colors duration-300">
    ...
    <nav class="sticky top-0 z-50 bg-white/90 dark:bg-[#020C1F]/90 backdrop-blur-md border-b border-slate-200 dark:border-white/10 py-4">
        <div class="max-w-7xl mx-auto px-6 flex items-center justify-between">
            ...
            <h1 class="font-montserrat font-black text-xl">Katalog <span class="text-[#A100FF]">Sponsorship</span></h1>
    ...
    <main class="flex-grow py-12">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center justify-between mb-12 gap-6">
                ...
                <div class="reveal-up">
                    <div class="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-bold tracking-widest border mb-3 bg-purple-100 border-purple-200 text-purple-700 dark:bg-[#A100FF18] dark:border-[#A100FF45] dark:text-[#A100FF]">
                        SPONSORSHIP MARKETPLACE
                    </div>
                    <h2 class="font-black text-3xl md:text-4xl font-montserrat leading-tight">
                        Dukung Event Terbaik
                    </h2>
                </div>

                <!-- Bar Pencarian Corporate Kapsul dengan Animasi -->
                <form action="{{ route('explore.sponsorships') }}" method="GET" class="reveal-up delay-100 flex flex-wrap lg:flex-nowrap items-center bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 p-2 rounded-2xl lg:rounded-full shadow-lg gap-2">
