        ...
        <table class="ticket-wrapper" cellpadding="0" cellspacing="0">
            ...
            <tr class="body-row">
                ...
                <td class="body-left">
                    ...
                    <div style="background-color: #FEF2F2; border: 1.5px solid #FCA5A5; border-left: 6px solid #EF4444; border-radius: 10px; padding: 9px 12px; margin-bottom: 12px;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                        ...
                        <span style="font-size: 10px; color: #991B1B; font-weight: bold; word-break: break-all; display: block; margin-top: 3px;">
                ...
                <td class="body-right">
                    ...
                    <div class="qr-card">
                        <img src="data:image/svg+xml;base64,{{ base64_encode(QrCode::format('svg')->size(100)->generate($ticket->ticket_code)) }}" alt="QR Code" width="100" height="100" style="display: block; margin: 0 auto;">
                    </div>
