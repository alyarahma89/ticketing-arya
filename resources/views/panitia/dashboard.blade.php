...
<head>
    ...
    <title>Dasbor Panitia - ARTIX ID</title>
...
<body class="bg-[#F8FAFC] text-slate-900 dark:bg-[#041B4A] dark:text-white min-h-screen flex flex-col">
    ...
    <nav class="bg-white/90 dark:bg-[#041B4A]/90 backdrop-blur-md border-b border-slate-200 dark:border-white/10 sticky top-0 z-50">
        <div class="max-w-md mx-auto px-6 h-20 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <!-- Inisial Nama Bulat -->
                <div class="w-10 h-10 rounded-full bg-blue-50 dark:bg-white/10 text-[#0066FF] dark:text-[#00C2FF] flex items-center justify-center font-black text-lg shadow-inner">
                    {{ substr(Auth::user()->name ?? 'P', 0, 1) }}
                </div>
                <div class="flex flex-col">
                    <span class="text-[14px] font-black font-montserrat leading-tight">{{ Auth::user()->name ?? 'Panitia Event' }}</span>
                    <span class="text-[11px] font-bold text-slate-500 dark:text-white/60 uppercase tracking-wider">Akses Lapangan</span>
                </div>
            </div>
    ...
    <main class="flex-grow max-w-md mx-auto w-full px-6 pt-8 pb-10">
        ...
        <div class="mb-8 text-center">
            ...
            <h1 class="font-black text-2xl font-montserrat text-slate-900 dark:text-white mb-1">
                Portal Panitia
            </h1>
            <p class="text-sm font-medium text-slate-500 dark:text-white/60">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <!-- Menu 1: Scanner (Dibuat paling besar membentang 2 kolom) -->
